...
// 
// Generated using ACDS version 14.0 200 at 2022.10.17.09:45:35
...
module pcihellocore_mm_interconnect_0 (
	...
	wire  [112:0] leds_s1_agent_rp_data;                                                  // leds_s1_agent:rp_data -> router_005:sink_data
	...
	wire    [6:0] butao_s1_burst_adapter_source0_channel;                                 // butao_s1_burst_adapter:source0_channel -> butao_s1_agent:cp_channel
	...
	wire    [6:0] display_s1_burst_adapter_source0_channel;                               // display_s1_burst_adapter:source0_channel -> display_s1_agent:cp_channel
	...
	wire  [112:0] router_005_src_data;                                                    // router_005:src_data -> leds_s1_rsp_width_adapter:in_data
	wire    [6:0] router_005_src_channel;                                                 // router_005:src_channel -> leds_s1_rsp_width_adapter:in_channel
	...
	wire  [148:0] leds_s1_rsp_width_adapter_src_data;                                     // leds_s1_rsp_width_adapter:out_data -> rsp_demux_004:sink_data
	wire          leds_s1_rsp_width_adapter_src_ready;                                    // rsp_demux_004:sink_ready -> leds_s1_rsp_width_adapter:out_ready
	wire    [6:0] leds_s1_rsp_width_adapter_src_channel;                                  // leds_s1_rsp_width_adapter:out_channel -> rsp_demux_004:sink_channel
	...
	wire    [6:0] router_006_src_channel;                                                 // router_006:src_channel -> butao_s1_rsp_width_adapter:in_channel
	...
	wire    [6:0] butao_s1_rsp_width_adapter_src_channel;                                 // butao_s1_rsp_width_adapter:out_channel -> rsp_demux_005:sink_channel
	...
	wire    [6:0] router_007_src_channel;                                                 // router_007:src_channel -> display_s1_rsp_width_adapter:in_channel
	...
	wire    [6:0] display_s1_rsp_width_adapter_src_channel;                               // display_s1_rsp_width_adapter:out_channel -> rsp_demux_006:sink_channel
	...
	wire  [148:0] cmd_mux_004_src_data;                                                   // cmd_mux_004:src_data -> leds_s1_cmd_width_adapter:in_data
	wire    [6:0] cmd_mux_004_src_channel;                                                // cmd_mux_004:src_channel -> leds_s1_cmd_width_adapter:in_channel
	...
	wire    [6:0] leds_s1_cmd_width_adapter_src_channel;                                  // leds_s1_cmd_width_adapter:out_channel -> leds_s1_burst_adapter:sink0_channel
	...
	wire    [6:0] cmd_mux_005_src_channel;                                                // cmd_mux_005:src_channel -> butao_s1_cmd_width_adapter:in_channel
	...
	wire    [6:0] butao_s1_cmd_width_adapter_src_channel;                                 // butao_s1_cmd_width_adapter:out_channel -> butao_s1_burst_adapter:sink0_channel
	...
	wire    [6:0] cmd_mux_006_src_channel;                                                // cmd_mux_006:src_channel -> display_s1_cmd_width_adapter:in_channel
	...
	wire    [6:0] display_s1_cmd_width_adapter_src_channel;                               // display_s1_cmd_width_adapter:out_channel -> display_s1_burst_adapter:sink0_channel
